...
export default class LatestVideoPerformanceComponent extends Component {
    render() {
        let videoTitle = "VIDEO TITLE";
        let explanation = "In the first 6 days and 9 hours, this is how your video performed compared to your channel averages.";
        return (
            <div className={"component latestVideoPerformanceComponent"}>
                <h1 className={"componentTitle"}>Latest Video Performance</h1>
                <img className={"videoThumbnail"} src={"https://via.placeholder.com/300x166"}/>
